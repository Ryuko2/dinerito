...
export const translations = {
  es: {
    ...
    add: 'Registrar Retiro',
    dashboard: 'Mi Libro',
    income: 'Depósitos',
    budgets: 'Asignación Mensual',
    goals: 'Metas',
    gastometer: 'Gastómetro',
    registerExpense: 'Registrar Retiro',
    paidBy: 'Pagado por',
    amount: 'Monto (MXN)',
    date: 'Fecha',
    ...
    other: 'Otro',
    submitExpense: 'Registrar Retiro',
    saving: 'Archivando...',
  ...
  en: {
    appTitle: 'First Bank of the West',
    appSubtitle: 'Kevin & Angeles',
    add: 'Record Withdrawal',
    dashboard: 'My Ledger',
    income: 'Deposits',
    budgets: 'Monthly Allowance',
    goals: 'Goals',
    gastometer: 'Gastometer',
    registerExpense: 'Record Withdrawal',
    paidBy: 'Paid by',
    amount: 'Amount (MXN)',
    date: 'Date',
    ...
    other: 'Other',
    submitExpense: 'Record Withdrawal',
    saving: 'Filing...',
    expenseSaved: 'Duly recorded in the ledger',
    expenseSavedDesc: 'Duly recorded in the ledger.',
    continue: 'Continue',
