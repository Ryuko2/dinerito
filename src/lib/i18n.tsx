...
export const translations = {
  es: {
    ...
    trend: 'Tendencia',
    noExpenses: 'Tu libro está limpio, partner. Registra tu primer gasto para comenzar.',
    credit: 'Crédito',
    debit: 'Débito',
    for: 'Para',
  ...
  en: {
    ...
    trend: 'Trend',
    noExpenses: 'Your ledger is clean, partner. Record your first expense to get started.',
    credit: 'Credit',
    debit: 'Debit',
    for: 'For',
